...
public class MyApplication extends Application {
    ...
    //TODO: when the user taps anywhere on the row in the recycler view then it should only delete the row from that particular recycler view
    ...
    // DO NOT ADD ANYMORE DEPENDENCIES TO THE EXISTING PROJECT.
}
